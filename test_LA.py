...
parser.add_argument('--root_path', type=str, default='/data/zsp/ssl/', help='Name of Experiment')
parser.add_argument('--exp', type=str,  default='baseline_20241005', help='exp_name')
...
snapshot_path = '../' + "model/{}/{}_{}_labeled/{}".format(FLAGS.dataset_name, FLAGS.exp, FLAGS.labelnum, FLAGS.model)
test_save_path = '../' + "model/{}/{}_{}_labeled/{}_predictions/".format(FLAGS.dataset_name, FLAGS.exp, FLAGS.labelnum, FLAGS.model)
...
def test_calculate_metric():
    ...
    net.load_state_dict(torch.load(save_mode_path,map_location="cuda:1"), strict=False)
